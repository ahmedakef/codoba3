  ...
  <div class="row"> <br>
    <nav class="navbar navbar-default">
     <div class="container-fluid">
      ...
      <a href="<?php bloginfo('url'); ?>"><img src="<?php bloginfo('template_url'); ?>/images/logo.png" class="img-circle img-thumbnail loogo" alt="قرطبة إنفوجرافيك" title="<?php bloginfo('name'); ?>"></a>
